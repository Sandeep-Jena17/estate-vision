  ...
  return (
    <div className="details-page">
      <div className="container details-container">
        ...
        {/* Main two-column layout — stacks on mobile, side-by-side on desktop */}
            ...
            <div style={{ marginTop: 32 }}>
              ...
              <div style={{ marginBottom: 40 }}>
                ...
                <div className="details-2col">
                  <div>
                    <div className="details-info-label">Type</div>
                    <div className="details-info-value">{property.type}</div>
                  </div>
                  <div>
                    <div className="details-info-label">Status</div>
                    <div className="details-info-value">{property.status}</div>
                  </div>
                  <div>
                    <div className="details-info-label">Furnishing</div>
                    <div className="details-info-value">{property.specs.furnished}</div>
                  </div>
                  <div>
                    <div className="details-info-label">Floor</div>
                    <div className="details-info-value">{property.specs.floor}</div>
                  </div>
                </div>
              </div>
            ...
            <div className="booking-panel">
              ...
              <div className="booking-body">
                <div style={{ marginBottom: 20 }}>
                  <label className="details-spec-label" style={{ display: 'block', marginBottom: 12 }}>
                    Visit Type
                  </label>
