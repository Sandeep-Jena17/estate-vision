...
/**
 * HomePage Component
 * Displays hero section with intro and featured properties
 */
export default function HomePage() {
  ...
  useSEO({
    ...
    description: 'Discover premium real estate listings with EstateVision. Browse thousands of properties, connect with expert agents, and find your ideal home, apartment, or commercial space.',
    keywords: 'real estate, property listings, buy property, sell property, rent apartment, houses for sale, estate marketplace',
    image: 'https://estatevision.com/og-image.jpg',
