...
export const MOCK_PROPERTIES: Property[] = [
  ...
  },
  {
    ...
    agent: {
      ...
      email: 'rohit.patel@estatevision.com',
      rating: 4.8,
    },
    premium: true,
    featured: true,
    ...
    createdAt: '2024-03-03T08:15:00Z',
  ...
  },
  {
    ...
    landmarks: [
      {
        name: 'Infocity IT Park',
        type: LandmarkType.OFFICE,
        icon: '💼',
        lat: 20.33,
        lng: 85.84,
        distanceKm: 1.5,
    ...
    agent: {
      ...
      email: 'ananya.mishra@estatevision.com',
      rating: 4.7,
    },
    premium: false,
    featured: false,
